...
const baseStyles = {
  solid:
    'inline-flex justify-center rounded-lg py-3 px-4 text-lg font-semibold tracking-tight shadow-sm focus:outline-none',
  outline:
    'inline-flex justify-center rounded-md border py-3 px-4 text-lg font-semibold tracking-tight focus:outline-none',
}
...
const variantStyles = {
  solid: {
    ...
    blue: 'bg-altGreen text-white focus-visible:outline-2 focus-visible:outline-offset-2  active:text-white/80 disabled:opacity-30 disabled:hover:bg-blue-600',
    white:
  ...
  outline: {
    slate:
      'border-slate-200 text-slate-900 focus-visible:outline-offset-2 focus-visible:outline-slate-600 active:border-slate-200 active:bg-slate-50 active:text-slate-900/70 disabled:opacity-40 disabled:hover:border-slate-200 disabled:hover:bg-transparent',
